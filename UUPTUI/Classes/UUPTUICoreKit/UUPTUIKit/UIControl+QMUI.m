...
UUPTSynthesizeUIEdgeInsetsProperty(qmui_outsideEdge, setQmui_outsideEdge)
UUPTSynthesizeBOOLProperty(qmui_automaticallyAdjustTouchHighlightedInScrollView, setQmui_automaticallyAdjustTouchHighlightedInScrollView)
UUPTSynthesizeBOOLProperty(canSetHighlighted, setCanSetHighlighted)
UUPTSynthesizeNSIntegerProperty(touchEndCount, setTouchEndCount)
UUPTSynthesizeIdCopyProperty(qmui_setHighlightedBlock, setQmui_setHighlightedBlock)
