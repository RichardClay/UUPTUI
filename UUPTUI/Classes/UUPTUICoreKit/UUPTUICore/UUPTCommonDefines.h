...
//  UUPT
//
//  Created by UUPT Team on 14-6-23.
//

#ifndef UUPTCommonDefines_h
#define UUPTCommonDefines_h
...
#define BeginIgnoreUIKVCAccessProhibited if (@available(iOS 13.0, *)) NSThread.currentThread.UUPT_shouldIgnoreUIKVCAccessProhibited = YES;
#define EndIgnoreUIKVCAccessProhibited if (@available(iOS 13.0, *)) NSThread.currentThread.UUPT_shouldIgnoreUIKVCAccessProhibited = NO;

#pragma mark - 变量-设备相关

/// 设备类型
#define IS_IPAD [UUPTHelper isIPad]
#define IS_IPOD [UUPTHelper isIPod]
#define IS_IPHONE [UUPTHelper isIPhone]
#define IS_SIMULATOR [UUPTHelper isSimulator]

/// 操作系统版本号，只获取第二级的版本号，例如 10.3.1 只会得到 10.3
#define IOS_VERSION ([[[UIDevice currentDevice] systemVersion] doubleValue])

/// 数字形式的操作系统版本号，可直接用于大小比较；如 110205 代表 11.2.5 版本；根据 iOS 规范，版本号最多可能有3位
#define IOS_VERSION_NUMBER [UUPTHelper numbericOSVersion]
...
#define APPLICATION_WIDTH [UUPTHelper applicationSize].width

/// 在 iPad 分屏模式下等于 app 实际运行宽度，否则等同于 DEVICE_HEIGHT
#define APPLICATION_HEIGHT [UUPTHelper applicationSize].height

/// 是否全面屏设备
#define IS_NOTCHED_SCREEN [UUPTHelper isNotchedScreen]
/// iPhone XS Max
#define IS_65INCH_SCREEN [UUPTHelper is65InchScreen]
/// iPhone XR
#define IS_61INCH_SCREEN [UUPTHelper is61InchScreen]
/// iPhone X/XS
#define IS_58INCH_SCREEN [UUPTHelper is58InchScreen]
/// iPhone 6/7/8 Plus
#define IS_55INCH_SCREEN [UUPTHelper is55InchScreen]
/// iPhone 6/7/8
#define IS_47INCH_SCREEN [UUPTHelper is47InchScreen]
/// iPhone 5/5S/SE
#define IS_40INCH_SCREEN [UUPTHelper is40InchScreen]
/// iPhone 4/4S
#define IS_35INCH_SCREEN [UUPTHelper is35InchScreen]
/// iPhone 4/4S/5/5S/SE
...
#define IS_ZOOMEDMODE [UUPTHelper isZoomedMode]

#pragma mark - 变量-布局相关

/// 获取一个像素
#define PixelOne [UUPTHelper pixelOne]
...
/// @warn 如果是用于 viewController，请使用 UIViewController(UUPT) UUPT_navigationBarMaxYInViewCoordinator 代替
...
#define SafeAreaInsetsConstantForDeviceWithNotch [UUPTHelper safeAreaInsetsForDeviceWithNotch]
...
#define PreferredValueForNotchedDevice(_notchedDevice, _otherDevice) ([UUPTHelper isNotchedScreen] ? _notchedDevice : _otherDevice)

/// 将所有屏幕按照宽松/紧凑分类，其中 iPad、iPhone XS Max/XR/Plus 均为宽松屏幕，但开启了放大模式的设备均会视为紧凑屏幕
#define PreferredValueForVisualDevice(_regular, _compact) ([UUPTHelper isRegularScreen] ? _regular : _compact)
...
#define IPAD_SIMILAR_SCREEN_WIDTH [UUPTHelper preferredLayoutAsSimilarScreenWidthForIPad]

#define _40INCH_WIDTH [UUPTHelper screenSizeFor40Inch].width
#define _58INCH_WIDTH [UUPTHelper screenSizeFor58Inch].width
#define _65INCH_WIDTH [UUPTHelper screenSizeFor65Inch].width
...
/// 字体相关的宏，用于快速创建一个字体对象，更多创建宏可查看 UIFont+UUPT.h
...
/// UIColor 相关的宏，用于快速创建一个 UIColor 对象，更多创建的宏可查看 UIColor+UUPT.h
#define UIColorMake(r, g, b) [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:1]
#define UIColorMakeWithRGBA(r, g, b, a) [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:a/1.0]
#define UIColorMakeHexColor(rgbValue)[UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:(1)]
...
#define UUPTViewAnimationOptionsCurveOut (7<<16)
#define UUPTViewAnimationOptionsCurveIn (8<<16)
...
#define UUPTStatusBarStyleDarkContent [UUPTHelper statusBarStyleDarkContent]
...
setterWithGetter(SEL getter) {
    ...
    [setterString appendString:getterString.UUPT_capitalizedString];
 ...
 *  issue: https://github.com/Tencent/UUPT_iOS/issues/203
 */
CG_INLINE CGFloat
