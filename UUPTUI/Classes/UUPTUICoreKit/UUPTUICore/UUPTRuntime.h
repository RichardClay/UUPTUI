...
//  UUPTKit
//
//  Created by UUPT Team on 2018/8/14.
//
...
@interface UUPTPropertyDescriptor : NSObject
...
OverrideImplementation(Class targetClass, SEL targetSelector, id (^implementationBlock)(__unsafe_unretained Class originClass, SEL originCMD, IMP (^originalIMPProvider)(void))) {
    ...
    IMP (^originalIMPProvider)(void) = ^IMP(void) {
        ...
        if (hasOverride) {
            ...
            // https://github.com/Tencent/UUPT_iOS/issues/776
    ...
    if (hasOverride) {
        ...
        const char *typeEncoding = method_getTypeEncoding(originMethod) ?: [targetClass instanceMethodSignatureForSelector:targetSelector].UUPT_typeEncoding;
 ...
 */
#define _UUPTTypeEncodingDetectorGenerator(_TypeInFunctionName, _typeForEncode) \
...
_UUPTTypeEncodingDetectorGenerator(Char, char)
_UUPTTypeEncodingDetectorGenerator(Int, int)
_UUPTTypeEncodingDetectorGenerator(Short, short)
_UUPTTypeEncodingDetectorGenerator(Long, long)
_UUPTTypeEncodingDetectorGenerator(LongLong, long long)
_UUPTTypeEncodingDetectorGenerator(NSInteger, NSInteger)
_UUPTTypeEncodingDetectorGenerator(UnsignedChar, unsigned char)
_UUPTTypeEncodingDetectorGenerator(UnsignedInt, unsigned int)
_UUPTTypeEncodingDetectorGenerator(UnsignedShort, unsigned short)
_UUPTTypeEncodingDetectorGenerator(UnsignedLong, unsigned long)
_UUPTTypeEncodingDetectorGenerator(UnsignedLongLong, unsigned long long)
_UUPTTypeEncodingDetectorGenerator(NSUInteger, NSUInteger)
_UUPTTypeEncodingDetectorGenerator(Float, float)
_UUPTTypeEncodingDetectorGenerator(Double, double)
_UUPTTypeEncodingDetectorGenerator(CGFloat, CGFloat)
_UUPTTypeEncodingDetectorGenerator(BOOL, BOOL)
_UUPTTypeEncodingDetectorGenerator(Void, void)
_UUPTTypeEncodingDetectorGenerator(Character, char *)
_UUPTTypeEncodingDetectorGenerator(Object, id)
_UUPTTypeEncodingDetectorGenerator(Class, Class)
_UUPTTypeEncodingDetectorGenerator(Selector, SEL)
...
#define _UUPTGetIvarValueGenerator(_TypeInFunctionName, _typeForEncode) \
...
_UUPTGetIvarValueGenerator(Char, char)
_UUPTGetIvarValueGenerator(Int, int)
_UUPTGetIvarValueGenerator(Short, short)
_UUPTGetIvarValueGenerator(Long, long)
_UUPTGetIvarValueGenerator(LongLong, long long)
_UUPTGetIvarValueGenerator(UnsignedChar, unsigned char)
_UUPTGetIvarValueGenerator(UnsignedInt, unsigned int)
_UUPTGetIvarValueGenerator(UnsignedShort, unsigned short)
_UUPTGetIvarValueGenerator(UnsignedLong, unsigned long)
_UUPTGetIvarValueGenerator(UnsignedLongLong, unsigned long long)
_UUPTGetIvarValueGenerator(Float, float)
_UUPTGetIvarValueGenerator(Double, double)
_UUPTGetIvarValueGenerator(BOOL, BOOL)
_UUPTGetIvarValueGenerator(Character, char *)
_UUPTGetIvarValueGenerator(Selector, SEL)
...
/**
 ...
 int count = UUPT_getProjectClassList(&classes);
 Class class = (__bridge Class)classes[0];
 @endcode
 */
FOUNDATION_EXPORT int UUPT_getProjectClassList(classref_t **classes);
